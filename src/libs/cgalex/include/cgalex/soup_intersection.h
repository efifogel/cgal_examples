#ifndef CGALEX_SOUP_INTERSECTION_H
#define CGALEX_SOUP_INTERSECTION_H
...
/*! computes the intersection of two polygon meshes using polygon soup operations.
 */
template <typename Mesh>
void soup_intersection(const Mesh& mesh1, const Mesh& mesh2, Mesh& result) {
