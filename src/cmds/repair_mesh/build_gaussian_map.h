#ifndef BUILD_GAUSSIAN_MAP_H
#define BUILD_GAUSSIAN_MAP_H
...
#include "Gaussian_map_builder.h"
...
void
build_gaussian_map(Graph& g, const FaceNormalMap& normals, Arrangement& gm,
  ...
  Gaussian_map_builder<Graph, Face_normal_map,
                       decltype(points), decltype(flags)>
