...
Mesh minkowski_sum_3(InputIterator begin1, InputIterator end1,
                     InputIterator begin2, InputIterator end2) {
  CGAL::Arr_face_overlay_traits<Arrangement, Arrangement, Arrangement, Adder>
    overlay_traits;
  Mesh ms;
  bool first = true;
  for (auto it1 = begin1; it1 != end1; ++it1) {
    for (auto it2 = begin2; it2 != end2; ++it2) {
      Arrangement gm;
      CGAL::overlay(*it1, *it2, gm, overlay_traits); /* \label{lst:minkSum:overlay} */
